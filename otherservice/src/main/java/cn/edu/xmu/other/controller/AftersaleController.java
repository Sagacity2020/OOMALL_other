...
public class AftersaleController {
    ...
    public Object updateAftersale(@PathVariable Long id, @Validated @RequestBody AftersaleVo vo, BindingResult bindingResult) {
        ...
        ReturnObject returnObj = aftersaleService.updateAftersale(id, vo);
    ...
    public Object confirmAftersaleById(@PathVariable Long id, BindingResult bindingResult) {
        if (logger.isDebugEnabled()) {
        ...
        Object returnObject = Common.processFieldErrors(bindingResult, httpServletResponse);
        if (returnObject != null) {
            logger.info("incorrect data received while confirmAftersaleById id = " + id);
            return returnObject;
        }
    ...
    public Object deliverAftersale(@PathVariable Long id, BindingResult bindingResult, @PathVariable Long shopId,@Validated @RequestBody AftersaleDeliverVo vo) {
        if (logger.isDebugEnabled()) {
