package cn.edu.xmu.advertisement.config;
...
public class  Swagger2Configuration {
    ...
    public static final String SWAGGER_SCAN_BASE_PACKAGE = "cn.edu.xmu.advertisement.controller";
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .title("权限模块")
                //描述
                .description("权限模块 Restful API接口")
                //创建人
